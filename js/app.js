...
const BADGES = [
    ...
    { id: "ps-basics",       name: "PS Basics",          icon: "⚡",  desc: "Complete PowerShell Basics modules" },
    { id: "rest-api-pro",    name: "REST API Pro",       icon: "🌐", desc: "Complete REST APIs with PowerShell" },
    { id: "auth-architect",  name: "Auth Architect",     icon: "🔐", desc: "Complete Jira Authentication module" },
    { id: "ticket-tamer",    name: "Ticket Tamer",       icon: "🎫", desc: "Complete Ticket Operations module" },
    { id: "alert-engineer",  name: "Alert Engineer",     icon: "🚨", desc: "Complete the Alerts module" },
    { id: "automation-hero", name: "Automation Hero",    icon: "🤖", desc: "Complete the full automation pipeline" },
...
function checkModuleBadges() {
    const progress = getProgress();
    const moduleMap = {
        2:  "ps-basics",        // Modules 1-3 cover PowerShell basics; tag at module 3 done
        3:  "rest-api-pro",     // Module 4: REST APIs with PowerShell
        6:  "auth-architect",   // Module 7: Authentication module
        7:  "ticket-tamer",     // Module 8: Querying Jira Tickets
        10: "alert-engineer",   // Module 11: Email Reporting (alerts/notifications)
        11: "automation-hero"   // Module 12: Putting It All Together
    };
...
async function initializeApp() {
    ...
    pyodide = null; // not used in this lab — execution is copy-to-terminal only
...
// ============================================================
// EXECUTION (Jira course = PowerShell + REST APIs)
//   Almost all examples need a real PowerShell terminal — so the
//   primary action is "Copy to clipboard" and run locally.
// ============================================================
...
async function runCode() {
    ...
    output.textContent =
        ...
        "Click the 'Copy' button, then paste it in a PowerShell terminal\n" +
        "(use Windows PowerShell or PowerShell 7).\n\n" +
        "Tip: ask the AI Lab Mentor on the right to explain what the script does\n" +
        "or what output you should expect when you run it.";
    trackCodeRun();
}
...
async function sendChat() {
    ...
    const chatPrompt = `You are a helpful PowerShell + Jira automation tutor. You answer questions about PowerShell, REST APIs, Jira Cloud REST API v3, and the script shown below. If a question is unrelated, politely decline.
...
Give a clear, helpful answer in 4-6 sentences. If the question is about the code, refer to specific cmdlets and parameters. If it's a broader Jira-API or PowerShell automation question, answer it directly.`;
        ...
        try {
            ...
            const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
                ...
                headers: {
                    ...
                    "X-Title": "Jira Automation with PowerShell - Interactive Course"
                },
                body: JSON.stringify({
                    model: model,
